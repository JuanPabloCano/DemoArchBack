...
using BackArchDemo.AppServices.Automapper;
using credinet.comun.api;
using credinet.comun.models.Users;
...
using User = Domain.Model.Entities.User;

namespace BackArchDemo.AppServices.Extensions
{
    /// <summary>
    /// Service Extensions
    /// </summary>
    public static class ServiceExtensions
    {
        ...
        public static IServiceCollection RegisterServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IUserEntityRepository, UserAdapter>();
